...
import com.example.herve.materialvideo.utils.AppUtils;
import com.example.herve.materialvideo.utils.SettingUtils;
...
public class GlideImageLoaderStrategy implements BaseImageLoaderStrategy {
    ...
    private void loadNormal(Context ctx, ImageLoader img) {
        ...
        } else if (img.getResource() != 0) {
            Glide.with(ctx).load(img.getResource()).placeholder(img.getPlaceHolder()).into(img.getImgView());
        }
    }
